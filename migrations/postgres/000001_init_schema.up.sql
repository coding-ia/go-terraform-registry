...
CREATE TABLE IF NOT EXISTS module_versions_deprecations
(
  ...
  FOREIGN KEY (module_version_id) REFERENCES module_versions(module_version_id) ON DELETE CASCADE
);
